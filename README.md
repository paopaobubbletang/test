...
中小学作文病句类型识别是一个多标签分类问题，预测一条句子是哪些类型的病句。病句类型标签同时包含词法、句法错误，本次评测任务共定义4个粗粒度错误类型和14个细粒度错误类型。病句类别定义及示例如下表1：

| Id | 粗粒度错误类型 | 细粒度错误类型 | 定义 | 例句 |
| --- | --- | --- | --- | --- |
| 1 | 字符级错误 | 缺字漏字 | 句子中缺少字（需要添加） | 有一次，他在搭一个十分繁杂的积木，我上前正要去帮他，他把我推了推说：“我不需要你们的帮，我觉得我自己可以拼好。”（缺少“助”） |
| 2 | 错别字错误 | 句子中出现错别字（需要修改或删除） | 今天的“云”游秦淮河到这里就要结束了，若想真实地感受秦谁河所承载的历史与韵味，还需亲自前去一览。（“谁”应为“淮”） |  |
| 3 | 缺少标点 | 应断句的地方没有使用标点把句子断开 | 俗语曰“技多不压身，我们掌握的技巧越多越广泛，我们的生活就越多姿多彩。（“曰”后缺少冒号） |  |
| 4 | 错用标点 | 标点使用错误，如本来应使用句号或分号却使用逗号 | 人之所以从众多动物中脱颖而出，主宰这个星球，是因为人类拥有更多利于生存的技巧，如直立行走，使用工具等；（应为“如直立行走、使用工具等。”） |  |
| 5 | 成分残缺型错误 | 主语不明 | 句子缺少主语，或主语不清晰，修改是要增加主语或使主语显现 | 看着手中的饭也没了胃口，出门往东边的坟墓看去，眼泪瞬间流下，滴落在了衣服上，出现深色小圆点，又接二连三的掉下来。（应该为“出现了深色小圆点，眼泪又接二连三地掉下来”） |
| 6 | 谓语残缺 | 句子缺少谓语，修改是要增加谓语 | 走进那里仿佛（走进了）爱丽丝梦游仙境，传统的旋转木马全换了形态各异的大鸟，旁边的转车也变成了狮子和老虎追逐，大家是不是也想来坐一坐呢？（缺少谓语“走进了”） |  |
| 7 | 宾语残缺 | 句子缺少宾语，修改是要增加宾语 | 然而我想说，并不是所有书籍都有能力完成承载读者（的任务），如同一艘船一样驶向对生活、对人类、乃至对社会的思考的海面的。（“完成xxx的任务”） |  |
| 8 | 其他成分残缺 | 修改是要增加除主语、谓语、宾语之外的其他情况 | 爱迪生为改良电灯艰苦奋斗13年，试用6000多材料，试验7000多次。失败便从头再来，直至最后发现了钨丝。（缺少“种”，应改为“试用6000多种材料”） |  |
| 9 | 成分赘余型错误 | 主语多余 | 一般是句子较长，前一个主语说出后，紧接着有一个较长、较复杂的状语，后面又接了指向同一个事物的主语；修改是要删除主语 | 我过了一会儿，我完成了测试。老师说等消息。（去掉第一个“我”） |
| 10 | 虚词多余 | 助词“的”、“所”的多余，需改是要删除虚词 | 那几根藤好像姑娘的染了个绿色的长头发。（“的”字赘余） |  |
